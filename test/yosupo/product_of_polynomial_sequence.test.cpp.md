...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/product_of_polynomial_sequence.test.cpp\"\n\
    ...
    \n\n#line 1 \"math/product_of_polynomial_sequence.hpp\"\n#include <vector>\n\n\
    ...
    \ };\n    return dfs(dfs, 0, polys.size());\n}\n#line 4 \"test/yosupo/product_of_polynomial_sequence.test.cpp\"\
    ...
    \      long long t;\n        is >> t;\n        r = mint(t);\n        return is;\n\
    \    }\n\nprivate:\n    int x;\n};\n#line 9 \"test/yosupo/product_of_polynomial_sequence.test.cpp\"\
