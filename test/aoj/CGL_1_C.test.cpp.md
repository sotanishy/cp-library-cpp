...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/CGL_1_C.test.cpp\"\n#define PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_1_C\"\
    ...
    \ a) || intersect(t, b)) return 1;\n    if (ccw(a, b, c) * ccw(a, b, d) < -1 &&\
    \ ccw(c, d, a) * ccw(c, d, b) < -1) return 2;\n    return 0;\n}\n\n// 0: inside\n\
    // 1: inscribe\n// 2: intersect\n// 3: circumscribe\n// 4: outside\nint intersect(const\
    ...
    \    cin.tie(nullptr);\n\n    Vec p0, p1;\n    cin >> p0 >> p1;\n    int q;\n\
    \    cin >> q;\n    while (q--) {\n        Vec p2;\n        cin >> p2;\n     \
    \   switch (ccw(p0, p1, p2)) {\n            case 0:\n            if (intersect(Segment(p0,\
    \ p1), p2)) cout << \"ON_SEGMENT\\n\";\n            else if (intersect(Segment(p1,\
    \ p2), p0)) cout << \"ONLINE_BACK\\n\";\n            else if (intersect(Segment(p2,\
    \ p0), p1)) cout << \"ONLINE_FRONT\\n\";\n            break;\n\n            case\
  ...
  code: "#define PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_1_C\"\
    ...
    \n    Vec p0, p1;\n    cin >> p0 >> p1;\n    int q;\n    cin >> q;\n    while\
    \ (q--) {\n        Vec p2;\n        cin >> p2;\n        switch (ccw(p0, p1, p2))\
    \ {\n            case 0:\n            if (intersect(Segment(p0, p1), p2)) cout\
    \ << \"ON_SEGMENT\\n\";\n            else if (intersect(Segment(p1, p2), p0))\
    \ cout << \"ONLINE_BACK\\n\";\n            else if (intersect(Segment(p2, p0),\
    \ p1)) cout << \"ONLINE_FRONT\\n\";\n            break;\n\n            case 1:\n\
    \            cout << \"COUNTER_CLOCKWISE\\n\";\n            break;\n\n       \
    \     case -1:\n            cout << \"CLOCKWISE\\n\";\n            break;\n  \
    \      }\n    }\n}\n\n"
  dependsOn:
